...
enum {
    ...
    MTKPOWER_CMD_GET_SCN_CHECK_SUPPORT       = 43,
    ...
    MTKPOWER_CMD_GET_SCN_PID                 = 211,
    MTKPOWER_CMD_GET_INTERACTIVE_CONTROL     = 212,
    MTKPOWER_CMD_GET_ADPF_CPU_LOAD_UP_BOOST_DURATION = 213,
    MTKPOWER_CMD_GET_ADPF_CPU_LOAD_UP_BOOST_SCALE = 214,
    MTKPOWER_CMD_GET_ADPF_CPU_LOAD_SPIKE_BOOST_DURATION = 215,
    MTKPOWER_CMD_GET_ADPF_CPU_LOAD_SPIKE_BOOST_SCALE = 216,
};
...
enum {
    ...
    MTKPOWER_SCREEN_OFF_ALWAYS_VALID = 3, // powerhal never disable this type
};
