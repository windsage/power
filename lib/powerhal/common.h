...
extern void getCputopoFromSysfs(int cpuNum, int *pnClusterNum, int *p_cpu_num, int *p_first_cpu);
...
//SPD: add powerencode by rui.zhou6 20240903 start
extern int get_property_value(char *prop);
extern char* get_decode_buf(const char *path);
extern int tran_powerhal_encode;
//SPD: add powerencode by rui.zhou6 20240903 end
