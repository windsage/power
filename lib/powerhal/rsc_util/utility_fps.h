...
#define PATH_FPSGO_CONTROL_BY_PID        "/sys/kernel/fpsgo/composer/fpsgo_control_pid"
#define PATH_FPSGO_EMA2_ENABLE_BY_PID    "/sys/kernel/fpsgo/xgf/xgf_ema2_enable_by_pid"
#define PATH_FPSGO_FILTER_DEP_TASK_ENABLE_BY_PID    "/sys/kernel/fpsgo/xgf/xgf_filter_dep_task_enable_by_pid"
#define PATH_FSTBV2_ENABLE_BY_PID        "/sys/kernel/fpsgo/fstb/fstb_self_ctrl_fps_enable_by_pid"
#define PATH_RESCUE_SECOND_ENABLE_BY_PID "/sys/kernel/fpsgo/fbt/fbt_attr_by_pid"
#define PATH_FSTB_NOTIFY_FPS_BY_PID      "/sys/kernel/fpsgo/fstb/notify_fstb_target_fps_by_pid"
#define PATH_FSTB_VSYNC_FPS_DISABLE_BY_PID      "/sys/kernel/fpsgo/fstb/fstb_vsync_app_fps_disable_by_pid"
...
extern int set_vsync_app_fps_disable_by_pid(int value, void *scn);
extern int unset_vsync_app_fps_disable_by_pid(int value, void *scn);
...
DECLARE_FBT_SET_ATTR_BY_PID(RT_prio1)
DECLARE_FBT_UNSET_ATTR_BY_PID(RT_prio1)

DECLARE_FBT_SET_ATTR_BY_PID(RT_prio2)
DECLARE_FBT_UNSET_ATTR_BY_PID(RT_prio2)

DECLARE_FBT_SET_ATTR_BY_PID(RT_prio3)
DECLARE_FBT_UNSET_ATTR_BY_PID(RT_prio3)
...
DECLARE_FBT_SET_ATTR_BY_PID(engine_cooler_enable)
DECLARE_FBT_UNSET_ATTR_BY_PID(engine_cooler_enable)
