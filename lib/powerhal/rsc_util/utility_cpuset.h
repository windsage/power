...
#ifndef ANDROID_UTILITY_CPUSET_H
#define ANDROID_UTILITY_CPUSET_H

extern int set_cpuset_ta_cpus(int value, void *scn);
extern int unset_cpuset_ta_cpus(int value, void *scn);
