...
extern int PowerHal_Wrap_EnableMultiDisplayMode(int32_t enable, int32_t fps);
extern int PowerHal_Wrap_getGameModeStatus(void);
extern int PowerHal_Wrap_EnableGameMode(int32_t enable, int32_t pid);
extern int PowerHal_Wrap_EnableCameraMode(int32_t enable, int32_t pid);
extern int RESM_setThreadHintPolicy(
...
extern int RESM_enableThreadHint(int tgid, bool enable);
__END_DECLS
